...
// Camarero: pedidos, estado de platos, llamados mesa/cocina, mesas asignadas.
// Admin: todo + ventas, reportes, carta, usuarios, auditoría y colaboración.
// ═══════════════════════════════════════════════════════════════════════════════
...
const LOCAL_WEBHOOKS = {
  orderCreate: "http://localhost:5678/webhook/order-create",
  camareroCall: "http://localhost:5678/webhook/camarero-call",
  kitchenCall: "http://localhost:5678/webhook/kitchen-call",
  billRequest: "http://localhost:5678/webhook/bill-request",
  receiptPrint: "http://localhost:5678/webhook/receipt-print",
  feedback: "http://localhost:5678/webhook/feedback",
  cashClose: "http://localhost:5678/webhook/cash-close",
};
